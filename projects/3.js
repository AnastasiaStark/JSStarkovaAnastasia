...
const Yes = isAllTrue([1, 2, 3, 4, 5], (n) => n < 10);
const No = isAllTrue([100, 2, 3, 4, 5], (n) => n < 10);
console.log(Yes);
console.log(No);
...
const isTrue = isSomeTrue([1, 2, 30, 4, 5], (n) => n > 20);
const isFalse = isAllTrue([100, 2, 3, 4, 5], (n) => n < 10);
...
console.log(returnBadArguments(testFunc, 2, 3));
...
console.log(calculator(16).div(9));
